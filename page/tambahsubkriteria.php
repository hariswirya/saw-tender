...
<form id="form" method="POST" action="./proses/prosestambah.php">
    ...
    <div class="panel-middle">
        ...
        <div class="group-input">
            ...
            <input type="text" class="form-custom" required autocomplete="off" placeholder="Nilai Kriteria" id="nilai" name="nilai">
        </div>
        <div class="group-input">
        ...
        <label for="catatan" ><b>Catatan!</b><br> Untuk perbandingan penawaran silahkan masukkan perbandingan peserta tender</label>
    </div>
